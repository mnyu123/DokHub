<template>
  ...
  >
    <SwiperSlide
      ...
      :key="idx"
      class="flex justify-center pb-8 overflow-visible"
    >
      <a
        :href="link.href"
        target="_blank"
...
const fixedLinks = [
  {
    ...
    imgSrc: require('@/assets/chzzk2.png'),
    alt:    '독케익 치지직 방송'
  },
  {
